...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profiles_dna_profile', 'TH01_right', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1))

        # Changing field 'Dna_Profile.TH01_left'
        db.alter_column(u'profiles_dna_profile', 'TH01_left', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1))
