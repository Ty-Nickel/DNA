...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dna_Profile.TH01_right'
        db.alter_column(u'profiles_dna_profile', 'TH01_right', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=3))
        ...
        # Changing field 'Dna_Profile.TH01_left'
        db.alter_column(u'profiles_dna_profile', 'TH01_left', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Dna_Profile.D21S11_left'
        db.alter_column(u'profiles_dna_profile', 'D21S11_left', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'Dna_Profile.TH01_right'
        db.alter_column(u'profiles_dna_profile', 'TH01_right', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'Dna_Profile.FGA_right'
        db.alter_column(u'profiles_dna_profile', 'FGA_right', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'Dna_Profile.D21S11_right'
        db.alter_column(u'profiles_dna_profile', 'D21S11_right', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'Dna_Profile.FGA_left'
        db.alter_column(u'profiles_dna_profile', 'FGA_left', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'Dna_Profile.TH01_left'
        db.alter_column(u'profiles_dna_profile', 'TH01_left', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
    ...
    models = {
        ...
        u'profiles.dna_profile': {
            ...
            'D21S11_left': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '3'}),
            'D21S11_right': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '3'}),
            ...
            'FGA_left': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '4'}),
            'FGA_right': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '4'}),
            'Meta': {'object_name': 'Dna_Profile'},
            'TH01_left': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '3'}),
            'TH01_right': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '3'}),
