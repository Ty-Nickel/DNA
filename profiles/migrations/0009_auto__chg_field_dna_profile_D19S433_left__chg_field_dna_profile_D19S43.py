...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dna_Profile.D19S433_left'
        db.alter_column(u'profiles_dna_profile', 'D19S433_left', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1))

        # Changing field 'Dna_Profile.D19S433_right'
        db.alter_column(u'profiles_dna_profile', 'D19S433_right', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'Dna_Profile.D19S433_left'
        db.alter_column(u'profiles_dna_profile', 'D19S433_left', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'Dna_Profile.D19S433_right'
        db.alter_column(u'profiles_dna_profile', 'D19S433_right', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
