...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_profile', 'country', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.country'
        db.alter_column(u'users_profile', 'country', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
